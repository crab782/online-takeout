...
) ENGINE=InnoDB AUTO_INCREMENT=2029616225982582787 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='员工表（商家管理员和平台管理员）';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=180 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='订单详情表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=68 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='订单表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=430 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='购物车表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `store` VALUES (1,'肯德基','北京市朝阳区建国路88号','400-823-8230','肯德基（KFC），全球知名快餐连锁品牌，主营炸鸡、汉堡等西式快餐','https://example.com/images/kfc.jpg',1,1,'06:00','23:00',5.00,20.00,'2026-02-13 00:55:47','2026-03-04 15:27:55',138,4.8),(2,'麦当劳17','北京市朝阳区建国路99号','400-920-0205','麦当劳（McDonald\'s），全球最大快餐连锁企业，主营汉堡、薯条等','https://example.com/images/mcdonalds.jpg',1,1,'06:00','23:00',5.00,20.00,'2026-02-13 00:55:47','2026-03-06 00:32:06',221,4.1),(3,'星巴克','北京市朝阳区建国路100号','400-820-6988','星巴克（Starbucks），全球知名咖啡连锁品牌，主营咖啡、茶饮等','https://example.com/images/starbucks.jpg',1,2,'07:00','22:00',3.00,15.00,'2026-02-13 00:55:47','2026-03-04 15:27:55',1056,4.6),(4,'必胜客1','北京市朝阳区建国路101号','400-812-3123','必胜客（Pizza Hut），全球知名披萨连锁品牌，主营披萨、意面等','https://example.com/images/pizzahut.jpg',1,1,'10:00','22:00',6.00,30.00,'2026-02-13 00:55:47','2026-03-06 00:14:15',187,4.7),(5,'喜茶16','北京市朝阳区建国路102号','400-888-8888','喜茶（HEYTEA），中国知名新式茶饮品牌，主营奶茶、果茶等','https://example.com/images/heytea.jpg',1,2,'09:00','22:00',4.00,10.00,'2026-02-13 00:55:47','2026-03-06 00:23:40',152,4.3),(6,'沙县','北京建国路22号','13722223333','沙县店铺描述','',1,NULL,'09:00','22:00',6.00,6.00,'2026-03-05 09:46:03','2026-03-05 20:10:25',0,5.0),(7,'兰州拉面','北京路3号','400-8888-8888','兰州拉面 牛肉面 凉面 牛肉干饺 牛肉炒饭 大盘鸡','https://example.com/images/kfc.jpg',0,NULL,'10:00','23:00',0.00,0.00,'2026-03-06 01:53:11','2026-03-06 01:53:11',0,5.0);
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='提现记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `withdrawal_record` VALUES (1,1,5816.00,1,'中国银行','6222021234567890123','测试账户','2026-02-26 15:00:51','2026-02-26 15:00:51',NULL),(8,5,37984.00,1,'中国银行','6222021234567890123','测试账户','2026-03-08 22:28:22','2026-03-08 22:28:22',NULL),(9,2,2276.70,1,'中国银行','6222021234567890123','测试账户','2026-03-08 22:42:52','2026-03-08 22:42:52',NULL);
...
-- Dump completed on 2026-03-09 15:07:53
